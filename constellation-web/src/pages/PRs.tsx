...
export function PRs() {
  return (
    <div style={{ padding: 16, overflowY: 'auto', height: '100%' }}>
      <h2 style={{ fontSize: 16, fontWeight: 600, color: 'var(--accent)', marginBottom: 16 }}>Pull Requests</h2>
      <div className="h-card">
        <div className="h-card-body" style={{ color: 'var(--text-300)', textAlign: 'center', padding: 24 }}>
