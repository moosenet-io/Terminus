  ...
  return (
    <div style={{ padding: 16, overflowY: 'auto', height: '100%', display: 'flex', flexDirection: 'column', gap: 12 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        {error && (
          <span style={{ fontSize: 11, color: 'var(--status-warning)', marginLeft: 'auto', display: 'inline-flex', alignItems: 'center', gap: 4 }}>
            {/* POL-13 (§9, no-emoji): inline alert-triangle replaces the ⚠ glyph. */}
            <svg aria-hidden width={11} height={11} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
