//! OpenHands tools — ported from the Python `openhands_tools.py` on CT322.
//!
...
const DEFAULT_WORKING_DIR: &str = "/home/coder/arcade";
...
for the task (default: /home/coder/arcade). model: optional model override. Returns \
    ...
    fn parameters(&self) -> Value {
        json!({
            ...
            "properties": {
                ...
                "working_dir": { "type": "string", "description": "Directory context for the task (default: /home/coder/arcade)" },
