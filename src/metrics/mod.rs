...
//! - **No secrets, no caller-controlled label values.** `tool` is the bare
//!   dispatched tool name (already a bounded, developer-controlled set —
//!   see `crate::registry::ToolRegistry`), never raw request arguments or
//!   error text.
