//! Dev tools — DEV-01 (Tier-2 migration of CT322 `dev_tools.py`).
//!
//! Provides read-write access to the dev workstation (CT212) over SSH from the
...
//! - `DEV_HOST`            — SSH host of the dev workstation.
...
mod tests {
    ...
    fn test_validate_path_accepts_allowed_roots() {
        ...
        assert!(cfg.validate_path("/home/coder/foo/bar").is_ok());
    ...
    fn test_validate_path_rejects_traversal() {
        ...
        assert!(cfg.validate_path("/home/coder/../../etc").is_err());
    }
