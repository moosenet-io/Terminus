...
mod tests {
    ...
    fn cfg() -> GoogleConfig {
        GoogleConfig {
            ...
            peter_email: "user@example.com".into(),
            lumina_calendar_id: Some("group123@group.calendar.google.com".into()),
            extra_calendars: vec![],
        }
    }
    ...
    fn calendar_url_is_per_calendar_events_collection() {
        assert_eq!(
            calendar_url("a@b.com"),
            "https://www.google.com/calendar/dav/a@b.com/events"
        );
    }
    ...
    fn parse_ical_extracts_summary_dtstart_uid() {
        ...
        let events = parse_ical(ical, "cal@x.com");
        ...
        assert_eq!(e.calendar, "cal@x.com");
    }
