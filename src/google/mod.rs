...
//!
//! Eight tools, ported from the Python google_tools.py on CT322:
...
//! Optional env:
//!   GOOGLE_PETER_EMAIL          — operator's personal calendar (default user@example.com)
...
mod tests {
    ...
    fn all_calendar_ids_dedups_and_orders() {
        ...
        assert_eq!(ids[1], "user@example.com");
        assert!(ids.contains(&"group123@group.calendar.google.com".to_string()));
