...
//!
//! ## Corpus layout (`INTAKE_CORPUS_V2_DIR`, default `/opt/chord/intake-corpus-v2`)
...
//!
//! Toolchains live under `/opt/chord-data/toolchains` on pvf1; the deploy script
...
/// Default v2 corpus location on pvf1; overridable via `INTAKE_CORPUS_V2_DIR`.
const DEFAULT_CORPUS_V2_DIR: &str = "/opt/chord/intake-corpus-v2";
